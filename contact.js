...
formulaire.addEventListener("submit", function (e) {
  ...
  function Personne(nom, prenom, email, phone) {
    (this.nom = nom),
      (this.prenom = prenom),
      (this.email = email),
      (this.phone = phone);
  ...
  function ProfilPerso(nom, prenom, email, phone, adressePostale) {
    Personne.call(this, nom, prenom, email, phone);
  ...
  function ProfilPro(nom, prenom, email, phone, siren) {
    Personne.call(this, nom, prenom, email, phone);
    this.siren = siren;
    this.presentation = function () {
...
function tableFiltre() {
  if ((filtre.value = "perso")) {
    contact = new ProfilPerso(
      formData.get("nom"),
      formData.get("prenom"),
      formData.get("email"),
